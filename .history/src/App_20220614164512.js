...
function App() {
  ...
  return (
    <>
    <div id="mainblock" style={{position:"relative",display:"inline-block",left:"25vw"}}>
      <div style={{backgroundColor:"red",height:"50vmin",width:"50vmin",position:"absolute",right:"25%",top:"25%"}}>
      </div>
