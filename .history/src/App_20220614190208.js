...
function App() {
  ...
  useEffect(() => {
    if(win==true){
      console.log('a');
      document.getElementById("win").style.display="inital";
    }
  }, [win])
  ...
  return (
    <>
    <div id="mainblock">
      <div id="win" style={{display:"none",backgroundColor:"red",height:"50vmin",width:"50vmin",position:"absolute",right:"25%",top:"25%",zIndex:"0"}}>
      </div>
