...
function App() {
  ...
  return (
    <>
    <div id="mainblock">
      <div id="win" style={{display:"none",backgroundColor:"black",height:"50vmin",width:"50vmin",position:"absolute",right:"25%",top:"25%",zIndex:"0",borderRadius:"50px"}}>
        <p style={{color:"white",position:"absolute",left:"35%",top:"40%"}}>
          WINNER {winner}
        </p>
      </div>
